...
export default function App() {
  ...
  const projects = [
    ...
    {name:"Blando Studio",url:"https://blandostudiio.com/",cat:"Creative Agency",stack:["Shopify","Liquid","Bootstrap"],color:"#ec4899",score:98,desc:"Minimalist creative studio portfolio with high-end typography and smooth page transitions.",stat:"5× more inquiries in Month 1",tag:"Design Studio"},
